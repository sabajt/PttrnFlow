...
+ (BackgroundLayer *)backgroundLayer
{
    ...
    TileSprite *background1 = [[TileSprite alloc] initWithImage:@"background_tile.png" repeats:ccp(repeatHorizontal, repeatVertical) color1:[ColorUtils cream] color2:[ColorUtils cream]];
